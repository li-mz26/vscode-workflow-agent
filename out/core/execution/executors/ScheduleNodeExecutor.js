...
exports.ScheduleNodeExecutor = void 0;
const NodeExecutor_1 = require("./NodeExecutor");
class ScheduleNodeExecutor extends NodeExecutor_1.NodeExecutor {
    constructor() {
        super(...arguments);
        this.type = 'schedule';
    }
    async execute(node, context) {
        const { cronExpression, timezone = 'UTC', enabled = true, maxRuns, endDate } = node.data;
        if (!cronExpression) {
...
exports.ScheduleNodeExecutor = ScheduleNodeExecutor;
//# sourceMappingURL=ScheduleNodeExecutor.js.map
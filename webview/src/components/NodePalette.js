...
const NodePalette = ({ onNodeDragStart }) => {
    ...
    return (<div style={{
            ...
            {Object.entries(groupedTypes).map(([category, types]) => (<div key={category} style={{ marginBottom: '16px' }}>
                    <h4 style={{
                margin: '0 0 8px 0',
                fontSize: '11px',
                fontWeight: 600,
                ...
                textTransform: 'uppercase'
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                        {types.map(nodeType => (<div key={nodeType.type} draggable onDragStart={() => onNodeDragStart(nodeType.type)} style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '8px',
                    padding: '8px 12px',

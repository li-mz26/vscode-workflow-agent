 ...
 */
function generatePathString(waypoints: Position[]): string {
 ...
 */
export function simplifyPath(waypoints: Position[]): Position[] {
    if (waypoints.length <= 2) return waypoints;
    
    const simplified: Position[] = [waypoints[0]];
